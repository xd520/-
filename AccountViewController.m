...
- (void)viewDidLoad {
    ...
    */
    ...
    UILabel *lineView7 = [[UILabel alloc] initWithFrame:CGRectMake(10,475 + 39.5, ScreenWidth - 10, 0.5)];
    lineView7.backgroundColor = [ColorUtil colorWithHexString:@"dedede"];
    [scrollView addSubview:lineView7];
    
    
    UILabel *lineView8 = [[UILabel alloc] initWithFrame:CGRectMake(10,515 + 39.5, ScreenWidth - 10, 0.5)];
    lineView8.backgroundColor = [ColorUtil colorWithHexString:@"dedede"];
    [scrollView addSubview:lineView8];
    
    
    UIView *lineView31 = [[UIView alloc] initWithFrame:CGRectMake(0,435, ScreenWidth, 0.5)];
    lineView31.backgroundColor = [ColorUtil colorWithHexString:@"dedede"];
    
    [scrollView addSubview:lineView31];
    
    
    UIView *lineView32 = [[UIView alloc] initWithFrame:CGRectMake(0,594.5, ScreenWidth, 0.5)];
    lineView32.backgroundColor = [ColorUtil colorWithHexString:@"dedede"];
    
    [scrollView addSubview:lineView32];
...
- (IBAction)callPhone:(UITouch *)sender
{
    ...
    if (view.tag == 0) {
        ...
        HideViewController *cv = [[HideViewController alloc] init];
        cv.hidesBottomBarWhenPushed = YES;
        [self.navigationController pushViewController:cv animated:YES];
        ...
        FriendsViewController *cv = [[FriendsViewController alloc] init];
        cv.hidesBottomBarWhenPushed = YES;
        [self.navigationController pushViewController:cv animated:YES];
...
- (IBAction)pushAccountMethods:(id)sender {
    //获取银行卡信息
    [self requestLogin:kBusinessTagGetJRMyBankcard];
}
@end
