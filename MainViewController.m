...
- (void)viewDidLoad
{
    ...
    NSArray *arrImg = @[@"house_icon",@"public_img",@"news_img"];
    for (int i = 0; i < 3; i++) {
...
- (void)recivedCategoryList:(NSMutableArray *)dataArray
{
        ...
        if (i == 1) {
          dayview = [[UIView alloc] initWithFrame:CGRectMake(0, 150*_autoSizeScaleY, ScreenWidth/2 - 1, 90*_autoSizeScaleY)];
           ...
           numYQH = [[UILabel alloc] init];
            ...
            //续存期
             nameLab = [[UILabel alloc] initWithFrame:CGRectMake(67, 13 + 90*(_autoSizeScaleY - 1)/2, ScreenWidth/2 - 77, 14)];
       ...
       dayview =  [[UIView alloc] initWithFrame:CGRectMake(0, 10 +  90*_autoSizeScaleY + 150*_autoSizeScaleY, ScreenWidth, 80*_autoSizeScaleY)];
           ...
           //加边框
            ...
            lab = [[UILabel alloc] init];
             ...
             nameLab = [[UILabel alloc] initWithFrame:CGRectMake(67, 13+ 90*(_autoSizeScaleY - 1)/2, ScreenWidth - 87, 14)];
  ...
  //赠送
        ...
        if ([[[dataList objectAtIndex:i] objectForKey:@"flag"] boolValue]) {
            ...
            UIImageView *img = [[UIImageView alloc] initWithFrame:CGRectMake(ScreenWidth - 60 - 25, -6, 75 , 25)];
        ...
        UILabel *labF2 = [[UILabel  alloc] initWithFrame:CGRectMake(27, 12+ 90*(_autoSizeScaleY - 1)/2, 45, 15)];
       ...
       // NSString *string = [[dataList objectAtIndex:1] objectForKey:@"GQMC"];
        ...
        nameLab.text = [[dataList objectAtIndex:i] objectForKey:@"GQMC"];
