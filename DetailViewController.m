...
//到期日期
 ...
 //收益方式
    UILabel *shouyiLab = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth - 120, descHeight + 135, 100, 14)];
    ...
    UILabel *shouyiLabTip = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth - 160, descHeight + 155, 140, 14)];
 ...
 //转让时间
    UILabel *transferLab = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth - 120, descHeight + 180, 100, 14)];
    ...
    UILabel *transferLabTip = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth - 160, descHeight + 200, 140, 14)];
